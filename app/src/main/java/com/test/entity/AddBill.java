...
public class AddBill {//配送费入账信息实体类
    private String id;
    private String deliverymanId;//骑手id
    private String status;// "配送费入账"
    private String time;//时间
    private String nowLeftMoney;//操作后余额
    private String orderMoney;//操作变动金额

    public AddBill(String id, String deliverymanId, String status, String time, String nowLeftMoney, String orderMoney) {
        this.id = id;
